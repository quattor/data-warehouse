		  ...
		  <div class="hero-unit page-header">
				...
				<div>
				    <form name="Search" class="form-inline">
				        <input data-toggle="tooltip" data-placement="top" data-animation="true" title="Path to a value, e.g. /hardware/model" type="text" placeholder="Attribute" name="attribute" id="attribute" onkeydown="if (event.keyCode == 13) getData()" value="<?php echo $_GET["attribute"] ?>"/>
